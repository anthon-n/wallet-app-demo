...
class TransferCompleteCashOutSlotsScreen extends StatefulWidget {
  double amount;
  TransferCompleteCashOutSlotsScreen({required this.amount});
  @override
  _TransferCompleteCashOutSlotsScreenState createState() =>
      _TransferCompleteCashOutSlotsScreenState();
}

class _TransferCompleteCashOutSlotsScreenState
    extends State<TransferCompleteCashOutSlotsScreen> {
  @override
