...
class TransferCompleteConvertPointsScreen extends StatefulWidget {
  int amount;
  TransferCompleteConvertPointsScreen({required this.amount});
  @override
  _TransferCompleteConvertPointsScreenState createState() =>
      _TransferCompleteConvertPointsScreenState();
}

class _TransferCompleteConvertPointsScreenState
    extends State<TransferCompleteConvertPointsScreen> {
  @override
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Column(children: <Widget>[
                    ...
                    children: <InlineSpan>[
                      ...
                      WidgetSpan(
                        ...
                        child: Transform.translate(
                          ...
                          child: Text('${(widget.amount / 5).toStringAsFixed(2)}',
                              style: TextStyle(
                                  fontFamily: 'KorolevCompressed',
                                  decoration: TextDecoration.none,
                                  color: Colors.black,
                ...
                Text(
                  '${widget.amount} Points Have Been Successfully\nConverted Into Free Play',
